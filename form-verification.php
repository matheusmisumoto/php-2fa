    ...
    <head>
        ...
        <style type="text/css">
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            a { color: #008df6; }
            h1 { font-size: 2.5em; font-weight: 100; text-align: center; }
            ...
            input[type='text'] { 
                ...
                padding: 4px; border-radius: 4px; width: 100%; box-sizing: border-box; font-family: 'Roboto'; font-weight: 100; font-size: 1.5em; color: #FFF; text-align: center; }
